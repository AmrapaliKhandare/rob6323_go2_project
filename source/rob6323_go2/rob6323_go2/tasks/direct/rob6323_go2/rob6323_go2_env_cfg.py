...
class Rob6323Go2EnvCfg(DirectRLEnvCfg):
    ...
    action_scale = 0.25
    action_space = 12
    observation_space = 48 + 4  # Added 4 for clock inputs # Update from Part 4.1
    state_space = 0
    debug_vis = True
    ...
    # Update from Part 1.1 for penalizing changing its leg commands quickly
